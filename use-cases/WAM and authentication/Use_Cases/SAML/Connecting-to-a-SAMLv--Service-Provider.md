...
An [Application](Applications.md) representing the Transfer Service to the Service Provider is provided in the backup. Perform the following operations to create an equivalent one:
