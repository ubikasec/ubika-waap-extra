...
module "ubikawaap" {
  ...
  product_version = "6-16-4-3053176d4f-b93163" # product version to select instance images, changing it will recreate all instances
  ...
  managed_disk_size       = 60              # size of the managed disk in GiB (default to 30GiB)

  nb_managed = 2 # number of managed instances

  autoscaled_product_version = "6-16-4-3053176d4f-b93163"         # product version to select instance images for autoscaled instances
