...
module "ubikawaap" {
  ...
  product_version = "6-11-12-c2037ae070-b61415" # product version to select instance images, changing it will recreate all instances
  ...
  autoscaled_product_version = "6-11-12-c2037ae070-b61415"         # product version to select instance images for autoscaled instances
