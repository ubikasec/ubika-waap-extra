...
module "ubikawaap" {
  ...
  product_version = "6-11-4-7d47970bb6-b43822" # product version to select instance images, changing it will recreate all instances
  ...
  autoscaled_product_version = "6-11-4-7d47970bb6-b43822"         # product version to select instance images for autoscaled instances
